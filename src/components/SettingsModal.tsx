...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-white dark:bg-black rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800 overflow-hidden"
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <button
                type="button"
                className="py-1 px-3 bg-neutral-200 dark:bg-neutral-800 hover:bg-neutral-300 dark:hover:bg-neutral-700 text-neutral-900 dark:text-neutral-100 text-xs font-medium rounded-lg transition-colors"
              >
            ...
            >
              ...
              <button
                type="button"
                className={`py-1 px-3 text-xs font-medium rounded-lg transition-colors ${
                  showDates
